...
def save_to_mongo(data):
    client = MongoClient("mongodb+srv://pojan599:S43m4n3aku%40@cluster0.kanfvvb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
if __name__ == "__main__":
    ...
    if not data or not all("Tanggal" in item and "Peringatan" in item for item in data):
        st.error("❌ Data kosong atau format salah. Pastikan setiap item memiliki 'Tanggal' dan 'Peringatan'.")
        st.stop()
